...
| `Kostenaufstellung.html` | **Gesondertes Kostenblatt:** Positionen, Marktpreise vs. Freundschaftspreis (12.800 € → 3.400 €), Konditionen, Backfisch-Garantie. | Im Browser öffnen; drucken ergibt ein sauberes A4-Blatt. |
...
- „300+ automatische Tests“ = 241 API-Checks (`npm test`) + 66 Browser-E2E-Checks (`server/test/ui.e2e.mjs`).
- „52 Crew · 5 Mazes“ = Umfang des Demo-Szenarios (`server/seed/`).
