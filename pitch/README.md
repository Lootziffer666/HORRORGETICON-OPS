...
| `Kostenaufstellung.html` | **Gesondertes Kostenblatt:** Positionen, Marktpreise vs. Freundschaftspreis (9.400 € → 3.400 €), Konditionen, Backfisch-Garantie. | Im Browser öffnen; drucken ergibt ein sauberes A4-Blatt. |
...
- „172 automatische Tests“ = 125 API-Checks (`npm test`) + 47 Browser-E2E-Checks (`server/test/ui.e2e.mjs`).
